	jQuery(document).ready(function($){
			...
			$("#smart-form").steps({
				...
				labels: {
					finish: "<span style='color: #920c16'>Submit Form</span>",
					next: "<span style='color: #920c16'>Continue</span>",
					previous: "<span style='color: #920c16'>Go Back</span>",
					loading: "<span style='color: #920c16'>Loading...</span>" 
				},
